"""
EJEMPLO: Service Layer - Mejores Prácticas
===========================================

Separa la lógica de negocio de las views para mejor testeo y mantenibilidad
"""
...
from .services import ProjectService, VideoService
